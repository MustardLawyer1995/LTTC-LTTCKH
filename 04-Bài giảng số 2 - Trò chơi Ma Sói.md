...
- Đặt $r_{m,n}$ là tỉ lệ thắng của phe dân trong tình huống có $m$ sói, $n$ dân và đang ở lượt đi của phe dân. Hiển nhiên ta có ngay $r_{m,n}=0$ khi $m \ge n$ và $r_{0,n} = 1$ khi $n \ge 1$ . Thế nên từ đây ta thống nhất rằng chỉ (cần) xét các giá trị $r_{m,n}$ với $0 \le m \le n$ . (Đã bao hàm điều kiện cần)
